...
# Configuração dos Node Groups para Produção - Academy
eks_managed_node_groups = {
  prod_nodes = {
    instance_types = ["t3.medium"]  # Volta para instância mais barata
    min_size       = 1
    max_size       = 1
    desired_size   = 1
...
# Configuração de acesso IAM para Produção
eks_access_entries = {
  prod_admin = {
    principal_arn = "arn:aws:iam::057096910794:role/voclabs"  # Substituir ACCOUNT pelo ID da conta
    policy_associations = {
...
# Configurações de monitoring para Produção
...
# Proteção contra deleção (habilitado para produção)
...
# Options do PostgreSQL para Produção
rds_options = []
...
# =============================================================================
backend_bucket = "terraform-state-techchallenge-equipe7"
backend_key    = "techchallenge3/terraform.tfstate"
