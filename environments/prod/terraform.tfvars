...
network_cluster_name = "togglemaster-eks-prod"

# =============================================================================
# VARIÁVEIS DO MÓDULO EKS-CLUSTER
# =============================================================================
eks_cluster_name = "togglemaster-eks-prod"
...
rds_db_name  = "techchallenge_prod"
...
dynamodb_tables = [
  {
    name           = "togglemaster-sessions-prod"
    hash_key       = "session_id"
