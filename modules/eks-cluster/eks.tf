...
# REMOVIDO: Locals complexos que causavam erros de referência
# Eram usados apenas para access entries (agora comentados)
# locals {
...
resource "aws_eks_cluster" "this" {
  ...
  # REMOVIDO: access_config que causava problemas em AWS Academy
  # authentication_mode = "API_AND_CONFIG_MAP" pode causar conflitos
  # access_config {
...
# REMOVIDO: Access entries complexos para ambiente simples
# Para AWS Academy, isso só adiciona complexidade e tempo de deployment
...
# REMOVIDO: Data source para security groups
# Não usado em nenhum lugar e só adiciona dependência
